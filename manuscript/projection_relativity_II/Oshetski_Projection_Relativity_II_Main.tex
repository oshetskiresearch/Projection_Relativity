...
The charged-lepton sector is represented on a three-sheet square-root mass plane. The proposed associating the two charged-current ladder orientations with the nine ordered sheet-pair incidences of the three-generation ledger. This motivates the candidate phase
\begin{equation}
\theta_K^{\rm PR}
=
